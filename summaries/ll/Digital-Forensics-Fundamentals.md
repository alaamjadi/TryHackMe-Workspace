...
| Tool                                                                        | Primary Use                                                                                              |
| :-------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------- |
| [FTK Imager](https://www.exterro.com/digital-forensics-software/ftk-imager) | Creating bit-by-bit disk images and analyzing their contents.                                            |
...
| [ExifTool](https://exiftool.org/)                                           | A tool used to read and write metadata (EXIF) in files, such as GPS coordinates in images.               |
