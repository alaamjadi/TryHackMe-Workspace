...
By typing `help` on any Meterpreter session you can list all available commands. Every version has different command options and it can be checked with `show options`.
